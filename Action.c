...
//	int n;
//		
//		int a = 	lr_paramarr_random();


	//n = rand() % 100 + 1;
	//char str[500]=("Value=_token=s09iVMSiVMUhJ8b3anr5mwUm74QIHHJMgg9YGF4y&firstName=iqra&lastName={randomNumber}&email=iqra{randomNumber}%s%40venturedive.com&selectedInquiry=Pick-ups+%26+returns&message=Nothing&phoneNumber%5BdialingCode%5D=%2B44&phoneNumber%5BnationalNumber%5D=3452965382&phoneNumber%5BcountryCode%5D=GB&marketingSource=direct&marketingCampaign=none&marketingMedium=none&marketingTerm=none&marketingContent=none",rand() % 100 + 1);
	char val[500];
	//val="",n;
	//val="Value=_token=s09iVMSiVMUhJ8b3anr5mwUm74QIHHJMgg9YGF4y&firstName=iqra&lastName={randomNumber}&email=iqra{randomNumber}%d%40venturedive.com&selectedInquiry=Pick-ups+%26+returns&message=Nothing&phoneNumber%5BdialingCode%5D=%2B44&phoneNumber%5BnationalNumber%5D=3452965382&phoneNumber%5BcountryCode%5D=GB&marketingSource=direct&marketingCampaign=none&marketingMedium=none&marketingTerm=none&marketingContent=none",n;
		
 lr_log_message("value of randm varaible %s",val);
	//printf("generated value is \n%d",n);
	 //sprintf("Value=_token=s09iVMSiVMUhJ8b3anr5mwUm74QIHHJMgg9YGF4y&firstName=iqra&lastName={randomNumber}&email=iqra{randomNumber}%s%40venturedive.com&selectedInquiry=Pick-ups+%26+returns&message=Nothing&phoneNumber%5BdialingCode%5D=%2B44&phoneNumber%5BnationalNumber%5D=3452965382&phoneNumber%5BcountryCode%5D=GB&marketingSource=direct&marketingCampaign=none&marketingMedium=none&marketingTerm=none&marketingContent=none", ENDITEM,
		                      //   LAST,"%s",n);

//	lr_output_message("value of random varaible %s",ran);
	...
	//lr_log_message("value of randm varaible %d",n);
...
//		LAST);
	...
	web_submit_data("contact-us_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=formdata", "Value=_token=s09iVMSiVMUhJ8b3anr5mwUm74QIHHJMgg9YGF4y&firstName=iqra&lastName=bibi&email=iqra{randomNumber}%40bystored.com&selectedInquiry=Pick-ups+%26+returns&message=Nothing&phoneNumber%5BdialingCode%5D=%2B44&phoneNumber%5BnationalNumber%5D=3452965382&phoneNumber%5BcountryCode%5D=GB&marketingSource=direct&marketingCampaign=none&marketingMedium=none&marketingTerm=none&marketingContent=none", ENDITEM,LAST);
	return 0;
